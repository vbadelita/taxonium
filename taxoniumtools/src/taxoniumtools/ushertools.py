...
from .core_mutations import (AAMutation, NucMutation, Gene, Codon, codon_table,
                             get_gene_name, get_genes_dict, get_mutations,
                             recursive_mutation_analysis, preorder_traversal,
                             preorder_traversal_internal,
                             preorder_traversal_iter, find_cds, find_codon,
                             GenbankLoader, NUC_ENUM)
...
class UsherMutationAnnotatedTree:
    ...
    def load_genbank_file(self, genbank_file):
        loader = GenbankLoader(genbank_file)
        self.genbank = loader.genbank
        self.cdses = loader.cdses
        self.genes = loader.genes
        self.nuc_to_codon = loader.nuc_to_codon
